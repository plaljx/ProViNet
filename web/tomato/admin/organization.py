...
class OrganizationForm(AddEditForm):
    ...
    name = forms.CharField(max_length=50,label=_("Name"), help_text=_("The name of the organization. Must be unique to all organizations. e.g.: BUPT"))
    description = forms.CharField(max_length=255, label=_("Label"), help_text=_("e.g.: Beijing University of Posts and Communications"))
    homepage_url = forms.CharField(max_length=255,label=_("Homepage url"), required=False, help_text=_("must start with protocol, i.e. http://niclab.bupt.edu.cn"))
    image_url = forms.CharField(max_length=255,label=_("Image url"), required=False, help_text=_("must start with protocol, i.e. http://niclab.bupt.edu.cn/logo.png"))	
