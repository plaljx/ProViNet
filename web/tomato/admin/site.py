...
class SiteForm(AddEditForm):
    name = forms.CharField(max_length=50, help_text="The name of the site. Must be unique to all sites. e.g.: BUPT")
    description = forms.CharField(max_length=255, label="Label", help_text="e.g.: Beijing University of Posts and Communications")
    ...
    location = forms.CharField(max_length=255, help_text="e.g.: Beijing, China")
